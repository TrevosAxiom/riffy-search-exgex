...
<div class="rs-plugin-page">
    ...
    <nav class="rs-mobile-tabbar" aria-label="<?php esc_attr_e('Primary mobile navigation', 'rifnote-search'); ?>">
        ...
        <details class="rs-mobile-menu">
            <summary aria-label="<?php esc_attr_e('Open menu', 'rifnote-search'); ?>"><span aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M4 7h16M4 12h16M4 17h16"/></svg></span><b><?php esc_html_e('Menu', 'rifnote-search'); ?></b></summary>
            <div class="rs-mobile-menu-panel">
                ...
                <div class="rs-mobile-menu-tab-panel is-active" data-rs-mobile-panel="main">
                    <?php foreach ($nav_groups as $group) : ?>
                        <div class="rs-mobile-menu-group">
